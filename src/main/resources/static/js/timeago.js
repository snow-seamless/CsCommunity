...
!function (root, factory) {
    ...
    function () {
        var indexMapEn = 'second_minute_hour_day_week_month_year'.split('_'),
            indexMapZh = '绉抇鍒嗛挓_灏忔椂_澶鍛╛鏈坃骞�'.split('_'),
            ...
            locales = {
                ...
                'zh_CN': function (number, index) {
                    if (index === 0) return ['鍒氬垰', '鐗囧埢鍚�'];
                    var unit = indexMapZh[parseInt(index / 2)];
                    return [number + unit + '鍓�', number + unit + '鍚�'];
                }
            },
         ...
         * var timeago = timeagoLib('2016-09-10', 'zh_CN'); // the relative date is 2016-09-10, and locale is zh_CN, so the 2016-09-11 will be 1澶╁墠.
         **/
         ...
         * var timeago = timeagoFactory('2016-09-10', 'zh_CN'); // the relative date is 2016-09-10, and locale is zh_CN, so the 2016-09-11 will be 1澶╁墠.
         **/
